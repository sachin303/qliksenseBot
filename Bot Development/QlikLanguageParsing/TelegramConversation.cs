...
namespace QlikConversationService
{
    ...
    public class TelegramConversation
    {
            ...
            , ref string MsgToSpeak, ref QSFoundObject ChartFound)
        {
            ...
            if (AppDimension!= null && AppDimension.Length > 0 && AppExpression!=null && AppExpression.Length > 0)
            {
                Measure = m.Name;
                Dimension = (d == null) ? AppDimension: d.Name;
            ...
            if (qsFounds.Length > 0)
            {
                ...
                if (msg == StringResources.nlGetChartNotFound)
                {
                    msg = string.Empty;
                }
                else
        ...
        private static string GetFilteredList(QSApp qa, ref string Dimension, List<QSFoundFilter> Filters = null, string UserName = "")
        {
            ...
            if (AppDimension != null && AppDimension.Length > 0)
            {
                Dimension = d.Name;
